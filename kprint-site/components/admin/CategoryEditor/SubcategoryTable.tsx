            ...
            .map((sub) => {
              ...
              return (
                <tr key={sub.id} className="border-t border-ink-100 hover:bg-ink-50">
                  ...
                  <td className="px-3 py-2.5 text-right font-mono text-[12px] text-mint-700 font-semibold">
                    {available}
                  </td>
                  ...
                  <td className="px-3 py-2.5 text-right">
                    <Link
                      ...
                      className="text-[11px] text-mint-700 font-semibold hover:underline inline-flex items-center"
                    >
                      관리
