      ...
      <div className="max-w-6xl mx-auto px-6 md:px-12 py-6 flex items-center justify-between gap-3">
        {prev ? (
          <Link
            ...
            className="flex items-center gap-2 text-[13px] text-ink-700 hover:text-mint-700 group"
          >
            <ChevronLeft className="w-4 h-4 text-ink-300 group-hover:text-mint-700" />
            <div>
        ...
        {next ? (
          <Link
            ...
            className="flex items-center gap-2 text-[13px] text-ink-700 hover:text-mint-700 group text-right"
          >
            <div>
              <div className="text-[10px] text-ink-500 uppercase tracking-wider">다음</div>
              <div className="font-bold">{next.name.ko}</div>
            </div>
            <ChevronRight className="w-4 h-4 text-ink-300 group-hover:text-mint-700" />
          </Link>
        ) : (
          <span />
        )}
