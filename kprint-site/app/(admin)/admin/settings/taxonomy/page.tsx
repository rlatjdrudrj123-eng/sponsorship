...
export default function TaxonomyPage() {
  ...
  return (
    <div className="space-y-5">
      ...
      {migrationNote && (
        <div className="bg-mint-50 border border-mint-100 rounded-btn p-3 text-[12px] text-mint-700">
          ✓ {migrationNote}
        </div>
      )}
        ...
        <Section
          ...
          right={
            <button
              type="button"
              onClick={() => addTag(kind)}
              className="text-[12px] text-mint-700 font-semibold hover:underline flex items-center gap-1"
            >
