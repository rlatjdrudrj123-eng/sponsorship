...
const DEFAULT_PERSONAS = [
  {
    ...
    socialProofNote: "작년 초기 참가사 12곳이 이 코스로 시작했어요",
    budgetNote: "평균 1,000~1,500만원 (스탠다드 패키지 + 단품 1~2개)",
    order: 0,
    isActive: true,
  },
  {
    ...
    socialProofNote: "해외 바이어 비중 높은 8곳이 이 조합 선택",
    budgetNote: "평균 2,000~3,000만원 (해외 뉴스레터 + 영문 쇼가이드 + 옥외)",
    order: 1,
    isActive: true,
  },
  {
    ...
    budgetMax: 5_000_000,
    socialProofNote: "예산 500만원 이하로 시작한 9곳",
    budgetNote: "평균 300~500만원 (디지털 배너 + SNS 인터뷰)",
    order: 2,
    isActive: true,
  },
  {
    ...
    socialProofNote: "메인 스폰서 3곳이 이 코스로 시그니처 픽업",
    budgetNote: "평균 3,000~5,000만원 (시그니처 + 옥외 + 천장배너)",
    order: 3,
    isActive: true,
  },
  {
    ...
    socialProofNote: "리드 확보 우선한 7곳이 이 채널 조합",
    budgetNote: "평균 800~1,500만원 (참관등록 + 세미나 배너 + 뉴스레터)",
    order: 4,
    isActive: true,
  },
];
